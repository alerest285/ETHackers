...
DEPS = [
    ...
    ("numpy",           "numpy",            None),
    ("scipy",           "scipy",            None),
    ("transformers",    "git+https://github.com/huggingface/transformers", "Must be git install for Qwen2.5-VL support"),
    ("huggingface_hub", "huggingface_hub",  None),
    ("accelerate",      "accelerate",       "Required for device_map support in transformers"),
